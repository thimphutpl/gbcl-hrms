...
# 	# 		#frappe.throw(str(frappe.utils.getdate(self.posting_date)))
# 	# 		if struct_row.salary_component=='Salary Advance':
# 	# 			if struct_row.to_date >= frappe.utils.getdate(self.posting_date):
...
# 			if struct_row.salary_component == 'Salary Advance':
# 				if payroll_entry and struct_row.to_date:
# 					if frappe.utils.getdate(payroll_entry.end_date) <= frappe.utils.getdate(struct_row.to_date):
# 						self.add_structure_component(struct_row, component_type)
# 					else:
# 						continue
# 			else:
